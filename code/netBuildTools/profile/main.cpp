 ...
 * Profiler:
 *
 * This code is going to take in a graph,
 * as well as a dijkstra file and a directory
 * of topic models in order to produce profile data.
 *
 * Optionally will need to calculate centrality data
 *
 * Optionally will need to calculate centrality data
 *
 */
