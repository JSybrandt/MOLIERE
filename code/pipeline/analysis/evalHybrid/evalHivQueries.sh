#!/bin/bash
#PBS -N hivHybrid
#PBS -l select=1:ncpus=20:mem=100gb,walltime=72:00:00
#PBS -o /home/jsybran/jobLogs/hivHybrid.out
#PBS -e /home/jsybran/jobLogs/hivHybrid.err
...
OUT=$RES/hiv-assc-dim/hybrid.opt.ev
