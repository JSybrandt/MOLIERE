...
#PBS -o /home/jsybran/jobLogs/runHC.out
#PBS -e /home/jsybran/jobLogs/runHC.err
...
VALIDATION_FILE=/scratch2/jsybran/validation_tmp/finished.highlyCited.paths
...
function run(){
  ...
  TMP_DIR=/scratch2/jsybran/validation_tmp/highlyCited
